...
export default function KomunitasLayout({
  ...
  const items = [
    { href: "/komunitas", label: "Ringkasan", icon: "LayoutDashboard" as const },
    { href: "/komunitas/kontribusi", label: "Kontribusi Saya", icon: "FolderOpen" as const },
    { href: "/komunitas/quick-submit", label: "Ajukan Budaya", icon: "Upload" as const },
    { href: "/komunitas/event", label: "Event", icon: "CalendarRange" as const },
  ];
